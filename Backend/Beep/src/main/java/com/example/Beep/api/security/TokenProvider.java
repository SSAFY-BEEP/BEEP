...
public class TokenProvider implements InitializingBean {
    ...
    public String createToken(Authentication authentication) {  //Authentication 객체를 받아서 토큰을 생성
    ...
    public Authentication getAuthentication(String token) { //토큰을 받아서 Authentication 객체를 리턴
        Claims claims = Jwts
                .parserBuilder()
                .setSigningKey(key)
                .build()
