...
public class BlockController {
    ...
    public ApiResult<?> getList() {
        return new ApiResult<>(blockService.getList(), HttpStatus.OK);
    }
...
//    public ApiResult<?> blockUser24(@PathVariable("messageId") String messageId) {
...
//    }
    ...
    @PreAuthorize("hasRole('USER')")
    public ApiResult<?> blockDelete(@PathVariable("messageId") Long messageId) {
