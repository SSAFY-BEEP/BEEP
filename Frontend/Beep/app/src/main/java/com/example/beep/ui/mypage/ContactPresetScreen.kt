...
@Composable
fun ContactPresetSuccessScreen(modifier: Modifier = Modifier, presetList: Array<String?>, viewModel: PresetViewModel) {
...
//        }
        ...
        Row(modifier = modifier
            ...
            Text(modifier = modifier.padding(10.dp,0.dp,0.dp,0.dp), text ="연락처 즐겨찾기 설정")
        }
